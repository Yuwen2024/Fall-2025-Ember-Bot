...
# Mini server for receiving coordinates

## First Time Setup

The code is in python_backend folder
...
Run the backend application: flask --app server run --host=0.0.0.0 --port=8000 --debug

# Mini server for video streaming

## First Time Setup

The code is in video_stream folder
...
Run the backend application: python3 main.py 
